...
_SENSORS: Final[dict[str, SensorEntityDescription]] = {
    ...
    # Rapid Pro 320W six-port telemetry
    "usb_c1_power": port_power("USB-C 1", precision=2),
    "usb_c1_voltage": port_voltage("USB-C 1"),
    "usb_c1_current": port_current("USB-C 1"),
    "usb_c2_power": port_power("USB-C 2", precision=2),
    "usb_c2_voltage": port_voltage("USB-C 2"),
    "usb_c2_current": port_current("USB-C 2"),
    "usb_c3_power": port_power("USB-C 3", precision=2),
    "usb_c3_voltage": port_voltage("USB-C 3"),
    "usb_c3_current": port_current("USB-C 3"),
    "usb_c4_power": port_power("USB-C 4", precision=2),
    "usb_c4_voltage": port_voltage("USB-C 4"),
    "usb_c4_current": port_current("USB-C 4"),
    "usb_a1_power": port_power("USB-A 1", precision=2),
    "usb_a1_voltage": port_voltage("USB-A 1"),
    "usb_a1_current": port_current("USB-A 1"),
    "pogo_power": port_power("Pogo", precision=2),
    "pogo_voltage": port_voltage("Pogo"),
    "pogo_current": port_current("Pogo"),
